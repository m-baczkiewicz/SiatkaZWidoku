...
Wtyczka pozwala jednym kliknięciem nałożyć na widoczny obszar mapy siatkę kwadratów o zadanym boku. Działa w trybie "nadpisywania" – każde kolejne uruchomienie usuwa poprzednią siatkę, co pozwala na dynamiczną pracę bez zaśmiecania projektu zbędnymi warstwami.

### Główne funkcje:
* **Generowanie z widoku:** Siatka powstaje tylko tam, gdzie aktualnie patrzysz.
* [cite_start]**Domyślny wymiar 4 ha:** Domyślna wielkość oczka to 200x200 metrów, idealna do szacowania powierzchni 4 hektarów.
...
* [cite_start]**Czysta legenda:** Automatycznie usuwa starą warstwę *Siatka z widoku* przed wygenerowaniem nowej.
...
* **Nazwa:** Siatka z widoku 
* **Wersja:** 1.1
* **Autor:** Michał Bączkiewicz 
* **Kontakt:** michal.baczkiewicz05@gmail.com 
